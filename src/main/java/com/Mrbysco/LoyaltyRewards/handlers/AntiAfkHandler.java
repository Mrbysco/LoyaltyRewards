...
public class AntiAfkHandler {
    public static final StatBase PLAY_NOT_IDLE = (new StatBasic(Reference.MOD_ID + ".stat.playNotIdle", new TextComponentTranslation(Reference.MOD_ID + ".stat.playNotIdle", new Object[0]), StatBase.timeStatType)).initIndependentStat().registerStat();
	
    private int timeSinceKeyPressed;	
	private static String AFK_TAG = Reference.MOD_PREFIX + "isAFK";
